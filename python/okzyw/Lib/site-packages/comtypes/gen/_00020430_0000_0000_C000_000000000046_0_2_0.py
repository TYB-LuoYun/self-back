...
__all__ = [ 'OLE_HANDLE', 'Checked', 'IFontEventsDisp', 'Default',
           'IPictureDisp', 'FONTSTRIKETHROUGH', 'VgaColor',
           'Unchecked', 'OLE_YPOS_CONTAINER', 'OLE_CANCELBOOL',
           'FONTSIZE', 'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'FONTNAME', 'Gray', 'LoadPictureConstants',
           'OLE_YSIZE_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'FONTUNDERSCORE', 'Font', 'OLE_OPTEXCLUSIVE', 'StdPicture',
           'Picture', 'StdFont', 'OLE_YPOS_PIXELS', 'FONTBOLD',
           'OLE_XSIZE_HIMETRIC', 'FontEvents', 'IPicture',
           'Monochrome', 'IFontDisp', 'OLE_XPOS_PIXELS',
           'OLE_YSIZE_PIXELS', 'OLE_TRISTATE', 'FONTITALIC', 'Color',
           'OLE_XSIZE_CONTAINER', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_HIMETRIC', 'OLE_XPOS_CONTAINER', 'OLE_COLOR',
           'IFont']
from comtypes import _check_version; _check_version('1.1.9', 1575709751.817330)
