...
ISpeechAudioFormat._methods_ = [
    ...
    COMMETHOD([dispid(3), helpstring('GetWaveFormatEx'), 'hidden'], HRESULT, 'GetWaveFormatEx',
              ( ['retval', 'out'], POINTER(POINTER(ISpeechWaveFormatEx)), 'SpeechWaveFormatEx' )),
...
__all__ = [ 'SPWORDPRONUNCIATION', 'DISPID_SpeechPhraseReplacements',
           'SSSPTRelativeToCurrentPosition', 'SRCS_Enabled',
           'DISPID_SpeechPhraseElements', 'SVP_20', 'SITooQuiet',
           'SGRSTTRule', 'SVEAudioLevel', 'DISPID_SAFGuid',
           'DISPID_SASetState', 'eLEXTYPE_PRIVATE13', 'SPAS_PAUSE',
           'DISPID_SLPSymbolic', 'SAFT48kHz8BitStereo',
           'DISPID_SBSWrite', 'SDA_Consume_Leading_Spaces',
           'DISPID_SAStatus', 'SpeechCategoryPhoneConverters',
           'SPSMF_SAPI_PROPERTIES', 'DISPID_SPEAudioSizeTime',
           'DISPID_SRGCmdLoadFromObject', 'tagSPTEXTSELECTIONINFO',
           'SGDisplay', 'DISPID_SPIReplacements', 'STCAll',
           'SRAImport', 'eLEXTYPE_PRIVATE20',
           'SpeechGrammarTagUnlimitedDictation', 'DISPID_SGRsItem',
           'eLEXTYPE_PRIVATE5', 'SpeechPropertyResourceUsage',
           'SVF_None', 'SVSFParseSapi', 'SRCS_Disabled',
           'SPCS_ENABLED', 'IStream', 'SRTSMLTimeout',
           'DISPID_SpeechObjectTokenCategory', 'SPFM_CREATE_ALWAYS',
           'DISPID_SLWsItem', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE7',
           'DISPID_SGRSTsCount', 'SECFDefault', 'eLEXTYPE_APP',
           'DISPID_SGRSRule', 'SVSFlagsAsync', 'SPPS_Function',
           'DISPID_SOTCSetId', 'eLEXTYPE_PRIVATE19',
           'DISPID_SPIStartTime', 'DISPID_SDKSetBinaryValue',
           'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVAudioOutputStream',
           'SPRS_ACTIVE', 'SVEAllEvents', 'ISpeechLexicon',
           'DISPID_SGRSTWeight', 'SRSInactiveWithPurge',
           'DISPID_SpeechAudioStatus', 'eLEXTYPE_PRIVATE15',
           'SAFTCCITT_uLaw_22kHzMono', 'SPSLMA', 'SpWaveFormatEx',
           'DISPID_SVSkip', 'SVSFParseSsml', 'SPEI_ADAPTATION',
           'DISPID_SRGCmdLoadFromResource', 'DISPID_SMSALineId',
           'DISPID_SRCreateRecoContext', 'SpAudioFormat',
           'DISPID_SGRSTsItem', 'ISpeechPhraseReplacements',
           'DISPID_SpeechRecoContext', 'DISPID_SpeechRecoResultTimes',
           'SP_VISEME_11', 'SAFT48kHz16BitStereo',
           'SPRS_ACTIVE_WITH_AUTO_PAUSE',
           'DISPID_SpeechGrammarRuleState',
           'DISPIDSPTSI_SelectionOffset', 'SPPHRASEREPLACEMENT',
           'DISPID_SVVoice', 'DISPID_SpeechAudioBufferInfo',
           'DISPID_SRGDictationSetState', 'SPVOICESTATUS',
           'SpObjectToken', 'SPAUDIOOPTIONS', 'SPDATAKEYLOCATION',
           'SPEI_START_SR_STREAM', 'DISPID_SRCERecognizerStateChange',
           'SPEI_REQUEST_UI', 'SPINTERFERENCE_NOSIGNAL',
           'DISPID_SVEBookmark', 'SPWT_PRONUNCIATION',
           'DISPID_SGRAttributes', 'DISPID_SPRulesCount',
           'SpeechAddRemoveWord', 'SAFTCCITT_uLaw_8kHzStereo',
           'ISpeechXMLRecoResult', 'DISPID_SGRsCommit',
           'DISPID_SpeechPhraseRule', 'SVPAlert', 'SPCT_SLEEP',
           'SP_VISEME_19', 'SpMMAudioOut',
           'DISPID_SpeechGrammarRuleStateTransitions',
           'eWORDTYPE_DELETED', 'ISpDataKey', 'SPWT_DISPLAY',
           'eLEXTYPE_RESERVED7', 'SPEI_MIN_SR', 'DISPID_SPPName',
           'DISPID_SPEDisplayText', 'SpeechPropertyAdaptationOn',
           'DISPID_SPRsCount', 'DISPID_SDKEnumKeys',
           'SPINTERFERENCE_LATENCY_TRUNCATE_END',
           'DISPID_SRRTStreamTime', 'DISPID_SPARecoResult',
           'SPSNotOverriden', 'SREStreamEnd', 'SPBOOKMARKOPTIONS',
           'DISPID_SVSInputSentenceLength', 'SGSEnabled',
           'SPEI_SENTENCE_BOUNDARY', 'ISpeechAudio',
           'SAFT22kHz8BitMono', 'SBONone', 'SPFM_OPEN_READWRITE',
           'SVSFPurgeBeforeSpeak', 'SpeechCategoryRecoProfiles',
           'SpeechCategoryRecognizers',
           'ISpeechTextSelectionInformation',
           'DISPID_SASCurrentDevicePosition',
           'DISPID_SpeechRecoContextEvents', 'SAFT44kHz16BitMono',
           'SPSTREAMFORMATTYPE', 'DISPID_SVSyncronousSpeakTimeout',
           'SpPhoneConverter', 'DISPID_SDKGetlongValue',
           'DISPID_SPANumberOfElementsInResult', 'DISPID_SFSClose',
           'SRADynamic', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
           'SpeechEngineConfidence', 'SASStop', 'SPWF_SRENGINE',
           'ISpeechPhraseProperties', 'SpeechVoicePriority',
           'SECLowConfidence', 'SINone', 'SPEVENT', 'DISPID_SGRName',
           'SAFTCCITT_uLaw_11kHzMono', 'SpeechWordPronounceable',
           'SRADefaultToActive', 'SPBINARYGRAMMAR',
           'DISPID_SPERequiredConfidence', 'DISPIDSPTSI',
           'DISPID_SPPEngineConfidence', '_SPAUDIOSTATE',
           'SAFT8kHz16BitMono', 'eWORDTYPE_ADDED',
           'SpeechDisplayAttributes', 'SPPHRASE', 'DISPID_SOTsItem',
           'SAFTGSM610_44kHzMono', 'ISpeechObjectToken',
           'DISPID_SpeechObjectToken', 'DISPID_SAFGetWaveFormatEx',
           'ISpeechGrammarRuleStateTransition', 'SAFT48kHz16BitMono',
           'DISPID_SGRSTNextState', 'SPBO_AHEAD',
           'SAFTNoAssignedFormat', 'DISPID_SPRDisplayAttributes',
           'ISpeechDataKey', 'DISPID_SGRSTransitions', 'DISPID_SGRId',
           ...
           'SpeechDataKeyLocation', 'DISPID_SGRInitialState',
           'DISPID_SPEAudioSizeBytes',
           'SpeechPropertyNormalConfidenceThreshold',
           'DISPID_SRCEInterference', 'SAFT8kHz16BitStereo',
           'SPSHT_EMAIL', 'SLTUser', 'DISPID_SASFreeBufferSpace',
           'SECFIgnoreKanaType', 'DISPID_SPRules_NewEnum',
           'DISPID_SVSpeakCompleteEvent',
           'DISPID_SPPNumberOfElements', 'SVPNormal',
           'DISPID_SGRsFindRule', 'SPEI_PHRASE_START',
           'SPGS_EXCLUSIVE', 'SDTAudio', 'ISpeechAudioBufferInfo',
           'SAFT32kHz16BitStereo', 'SP_VISEME_10',
           'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechBaseStream',
           'DISPID_SMSGetData', 'SpeechAudioFormatGUIDWave',
           'SPLO_DYNAMIC', 'SPWORDTYPE', 'DISPID_SpeechMMSysAudio',
           'DISPID_SGRSTPropertyId', 'SVF_Emphasis',
           'DISPID_SASCurrentSeekPosition',
           'DISPID_SRGCmdSetRuleIdState',
           'DISPID_SGRSAddWordTransition',
           'DISPID_SpeechLexiconWords', 'DISPID_SPRuleFirstElement',
           'SAFTGSM610_22kHzMono', 'SASClosed', 'DISPID_SLGetWords',
           'DISPID_SpeechObjectTokens', 'SREAdaptation',
           'DISPID_SpeechRecoResult2', 'SDTRule',
           'Speech_StreamPos_RealTime', 'DISPID_SRSetPropertyNumber',
           'ISpeechMemoryStream', 'SPVPRI_ALERT', 'SSTTDictation',
           'ISpRecoResult', 'SRAORetainAudio', 'DISPID_SLWsCount',
           'DISPID_SGRAddState', 'SP_VISEME_9', 'STCLocalServer',
           'SpeechTokenContext', 'DISPID_SVAlertBoundary',
           'DISPID_SLRemovePronunciation',
           'DISPID_SpeechPhraseAlternates', 'DISPID_SPAsCount',
           'ISpProperties', 'DISPID_SVEStreamEnd',
           'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SDKSetStringValue',
           'DISPID_SRSClsidEngine', 'SPEI_RESERVED3',
           'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE11', 'SVP_11',
           'SPSSuppressWord', 'SpeechAllElements', 'SVSFParseMask',
           'SpeechVisemeType', 'SECFIgnoreCase',
           'DISPID_SpeechPhraseProperties',
           'DISPID_SRAudioInputStream', 'Speech_Default_Weight',
           'ISpPhoneConverter', 'SpeechUserTraining',
           'DISPID_SRGDictationLoad',
           '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPBO_NONE',
           'SpeechBookmarkOptions', 'DISPID_SpeechVoiceEvent',
           'eLEXTYPE_PRIVATE1', 'DISPID_SMSADeviceId', 'SSFMCreate',
           'LONG_PTR', 'SPADAPTATIONRELEVANCE', 'SVP_9',
           'eLEXTYPE_PRIVATE6', 'SECFNoSpecialChars',
           'DISPID_SVSInputWordPosition', 'DISPID_SGRAddResource',
           'DISPID_SRGCmdLoadFromProprietaryGrammar',
           'DISPID_SRGetFormat', 'ISpVoice', 'SPCT_COMMAND',
           'SREHypothesis', 'eLEXTYPE_PRIVATE4',
           'DISPID_SABufferNotifySize',
           'DISPID_SVSInputSentencePosition', 'DISPID_SPIGrammarId',
           'DISPID_SAVolume', 'SPSNoun', 'DISPID_SpeechDataKey',
           'SASRun', 'DISPID_SPIRule', 'SRSEIsSpeaking',
           'SPAR_Medium', 'ISpXMLRecoResult', 'DISPID_SABIBufferSize',
           'SPEI_VISEME', 'SPAUDIOBUFFERINFO',
           'SpeechGrammarRuleStateTransitionType', 'SPEVENTENUM',
           'eLEXTYPE_PRIVATE18', 'SVSFIsXML', 'SpeechAudioState',
           'DISPID_SPEs_NewEnum', 'eLEXTYPE_PRIVATE10',
           'DISPID_SRRTOffsetFromStart',
           'ISpPhoneticAlphabetSelection', 'ISpMMSysAudio',
           'DISPID_SPRFirstElement', 'DISPID_SRGState', 'SPAO_NONE',
           'DISPID_SpeechGrammarRules', 'DISPID_SGRsAdd', 'SVP_17',
           'SRSInactive', 'DISPID_SRGIsPronounceable', 'SBOPause',
           'SPRULESTATE', 'SVP_10', 'SVEBookmark',
           'SPINTERFERENCE_LATENCY_WARNING', 'SpUnCompressedLexicon',
           'DISPID_SPCIdToPhone', 'DISPID_SPPId',
           'SpInprocRecognizer', 'SECNormalConfidence',
           'DISPID_SOTsCount', 'DISPID_SOTGetDescription',
           'DISPID_SLPPartOfSpeech', 'DISPID_SOTCGetDataKey',
           'DISPID_SOTCId', 'SVP_19', 'SpStream', 'DISPID_SVEViseme',
           'DISPIDSPTSI_ActiveOffset', 'SPPS_LMA', 'SINoise',
           'DISPID_SOTs_NewEnum', 'DISPID_SMSSetData',
           'DISPID_SGRsCommitAndSave', 'SPSModifier',
           'ISpeechMMSysAudio',
           'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
           'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'STCInprocServer',
           'DISPID_SPIGetDisplayAttributes',
           'DISPID_SpeechPhraseProperty', 'ISpRecoCategory',
           'ISpeechRecoGrammar', 'SPSHORTCUTPAIRLIST',
           'DISPID_SLPType', 'SpeechEmulationCompareFlags',
           'SpLexicon', 'SAFTADPCM_8kHzMono', 'ISpeechAudioStatus',
           'ISpEventSource', 'SREPropertyNumChange',
           'SpeechTokenShellFolder', 'ISpeechPhraseAlternate',
           'SSTTWildcard', 'DISPID_SLGenerationId', 'DISPID_SRCState',
           'SPINTERFERENCE_TOOSLOW', 'SECFEmulateResult',
           'SWTDeleted', 'DISPID_SRRRecoContext', 'SPBO_TIME_UNITS',
           'DISPID_SPCLangId', 'SAFTCCITT_uLaw_8kHzMono',
           'SECHighConfidence', 'SAFTExtendedAudioFormat',
           'STSF_CommonAppData', 'SPAR_Low', 'ISpResourceManager',
           'DISPID_SRCCreateGrammar', 'SpeechVoiceEvents',
           'SpeechRuleState', 'DISPID_SRCVoicePurgeEvent',
           'SAFT22kHz16BitStereo', 'DISPID_SRSetPropertyString',
           'ISpeechVoiceStatus', 'ISpEventSink',
           'DISPID_SDKGetBinaryValue', 'SPEI_START_INPUT_STREAM',
           'DISPID_SVSLastResult', 'SVSFDefault',
           'SAFTCCITT_ALaw_8kHzStereo', 'SAFT11kHz8BitMono',
           'ISpeechGrammarRuleStateTransitions', 'SVEVoiceChange',
           'SITooFast', 'SAFTADPCM_44kHzStereo',
           'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGetPropertyString',
           'DISPID_SRRDiscardResultInfo', 'SPINTERFERENCE_TOOQUIET',
           'SVEStartInputStream', 'DISPID_SpeechWaveFormatEx',
           'DISPID_SLWWord', 'SGRSTTWord', 'SPEI_VOICE_CHANGE',
           'DISPID_SPELexicalForm', 'ISpeechBaseStream',
           'SPPS_NotOverriden', 'DISPID_SRGReset',
           'SpeechVoiceCategoryTTSRate', 'DISPID_SPRsItem',
           'DISPID_SRGSetTextSelection', 'DISPID_SOTCDefault',
           'DISPID_SPPConfidence', 'ISpeechResourceLoader',
           'SPRECORESULTTIMES', 'SGDSActiveUserDelimited',
           'SAFT12kHz8BitMono', 'SVSFPersistXML', 'eLEXTYPE_PRIVATE2',
           'SVP_12', 'ISpeechRecognizer', 'DISPID_SRCEBookmark',
           'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
           'ISequentialStream', 'SPRULE', 'ISpRecognizer',
           'DISPID_SOTGetStorageFileName', 'DISPID_SOTSetId',
           'DISPID_SRGSetWordSequenceData', 'SVEPrivate',
           'DISPID_SLPPhoneIds', 'DISPID_SPAsItem',
           'STCInprocHandler', 'DISPID_SGRSTPropertyName',
           'DISPID_SVSpeak', 'SPEI_RESERVED5',
           'DISPID_SGRSAddRuleTransition', 'SpeechRecoEvents',
           'ISpeechWaveFormatEx', 'DISPID_SPRText', 'SVEViseme',
           'SGLexical', 'DISPID_SPRulesItem',
           'SpTextSelectionInformation', 'SAFTCCITT_ALaw_22kHzMono',
           'SPGRAMMARWORDTYPE', 'DISPID_SDKEnumValues',
           'SAFT16kHz8BitStereo', 'SP_VISEME_7',
           'SpeechDictationTopicSpelling', 'SAFTADPCM_22kHzMono',
           'SAFTGSM610_8kHzMono', 'DISPID_SpeechAudioFormat',
           'DISPID_SRCRetainedAudioFormat', 'DISPID_SPAPhraseInfo',
           'SPEI_SR_BOOKMARK', 'DISPID_SPPChildren',
           'SPDKL_LocalMachine', 'DISPID_SPEActualConfidence',
           'SpStreamFormatConverter',
           'DISPID_SRCEPropertyStringChange',
           'DISPID_SPAStartElementInResult',
           'DISPID_SpeechPhraseElement', 'DISPID_SpeechXMLRecoResult',
           'SWPKnownWordPronounceable', 'SPEI_MAX_TTS',
           'SpeechVoiceSkipTypeSentence', 'SDTProperty',
           'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPEAudioStreamOffset',
           'SAFT16kHz16BitMono', 'SECFIgnoreWidth', 'SpFileStream',
           'ISpeechPhraseRule', 'DISPID_SPACommit', 'SVEPhoneme',
           'ISpeechFileStream', 'SDTLexicalForm',
           'DISPID_SRCEPhraseStart', 'SP_VISEME_5', 'SP_VISEME_13',
           'SPEI_UNDEFINED', 'DISPID_SRCVoice',
           'SpeechTokenIdUserLexicon', 'SGDSInactive',
           'SREStateChange', 'DISPID_SPERetainedStreamOffset',
           'DISPID_SAEventHandle', 'ISpRecoContext',
           'DISPID_SRCCreateResultFromMemory', 'SAFT11kHz8BitStereo',
           'DISPID_SBSFormat', 'SPXMLRESULTOPTIONS', 'SVF_Stressed',
           'DISPID_SGRs_NewEnum', 'DISPID_SVSCurrentStreamNumber',
           'DISPID_SVESentenceBoundary', 'SAFT32kHz8BitMono',
           'SRAONone', 'SAFTADPCM_22kHzStereo', 'SPAO_RETAIN_AUDIO',
           'SpeechVoiceSpeakFlags', 'SGRSTTEpsilon', 'SPAS_CLOSED',
           'ISpRecognizer3', 'DISPID_SPPValue', 'SVP_18',
           'DISPID_SVWaitUntilDone', 'SP_VISEME_14',
           'SpPhraseInfoBuilder', 'SPPS_Noncontent',
           'DISPID_SADefaultFormat', 'SPFM_CREATE',
           'ISpeechPhraseRules', 'ISpAudio',
           'DISPID_SOTMatchesAttributes', 'DISPID_SpeechPhraseInfo',
           'SREAllEvents', 'STSF_FlagCreate', 'SPEI_PHONEME',
           'DISPID_SGRsDynamic', 'DISPID_SpeechPhraseBuilder',
           'SVP_16', 'DISPID_SRCAudioInInterferenceStatus',
           'SPEI_TTS_BOOKMARK', 'DISPID_SPEPronunciation',
           'DISPID_SpeechAudio', 'SVSFNLPMask', 'ISpeechRecoResult',
           'SVSFUnusedFlags', 'eLEXTYPE_RESERVED6', 'DISPID_SRGId',
           'DISPID_SpeechPhoneConverter', 'DISPID_SLPsCount',
           'tagSTATSTG', 'SPLOADOPTIONS', 'SAFTCCITT_ALaw_8kHzMono',
           'DISPID_SVSVisemeId', 'ISpNotifyTranslator',
           'tagSPPROPERTYINFO', 'eLEXTYPE_PRIVATE8', 'SPSMF_UPS',
           'DISPID_SFSOpen', 'SpeechTokenValueCLSID',
           'DISPID_SRRSetTextFeedback', 'SPAUDIOSTATE',
           'DISPID_SVSpeakStream', 'DISPID_SpeechLexiconWord',
           'SDA_Two_Trailing_Spaces', 'SAFTDefault',
           'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPHRASERULE',
           'IInternetSecurityMgrSite', 'DISPID_SPRuleParent',
           'DISPID_SRCEStartStream', 'DISPID_SVVolume',
           'DISPID_SPEEngineConfidence', 'SDTAlternates',
           'SPEI_INTERFERENCE', 'DISPID_SVPriority',
           'DISPID_SWFEChannels', 'SPWT_LEXICAL', 'SDTReplacement',
           'SVP_1', 'DISPID_SLWPronunciations',
           'DISPID_SLGetPronunciations', 'DISPID_SRGetPropertyNumber',
           'ISpeechPhraseInfo', 'SWPUnknownWordPronounceable',
           'ISpNotifySource', 'eLEXTYPE_PRIVATE12',
           'SpeechLexiconType', 'DISPID_SPPParent', 'SPRST_INACTIVE',
           'DISPID_SRRAudioFormat', 'ISpRecognizer2',
           'DISPID_SRGCmdLoadFromFile', 'SRERecognition',
           'SPFM_NUM_MODES', 'SRAExport', 'SPAR_High',
           'DISPID_SRRGetXMLErrorInfo', 'DISPID_SWFEFormatTag',
           'SRSActiveAlways', 'SRSEDone', 'DISPID_SRCEEnginePrivate',
           'DISPID_SPIElements', 'SpMMAudioIn', 'SVP_4',
           'SpResourceManager',
           'SpeechPropertyLowConfidenceThreshold', 'SVEWordBoundary',
           'DISPID_SRCESoundEnd', 'SGRSTTTextBuffer',
           'DISPID_SpeechRecoResult', 'SpCompressedLexicon',
           'SDA_One_Trailing_Space', 'DISPID_SOTDisplayUI',
           'ISpSerializeState', 'DISPID_SpeechGrammarRule',
           'ISpeechLexiconPronunciation', 'DISPID_SRCRetainedAudio',
           'DISPID_SpeechPhraseRules', 'SGRSTTWildcard',
           'DISPID_SDKDeleteValue', 'DISPID_SRSCurrentStreamNumber',
           'DISPID_SRCRecognizer', 'SpeechTokenKeyAttributes',
           'DISPID_SAFType', 'SWTAdded', 'SPDKL_DefaultLocation',
           'SPAUDIOSTATUS', 'SVSFParseAutodetect',
           'SpeechGrammarWordType', 'DISPID_SPEsItem',
           'SPEI_RESERVED2', 'DISPID_SVGetVoices',
           'SPEI_END_INPUT_STREAM', 'SpMMAudioEnum',
           'SGRSTTDictation', 'SpeechRetainedAudioOptions',
           'SFTSREngine', '_ISpeechVoiceEvents',
           'DISPID_SOTRemoveStorageFileName',
           'DISPID_SPERetainedSizeBytes', 'SpeechAudioFormatType',
           'DISPID_SPIGetText', 'SREPrivate',
           'ISpeechGrammarRuleState', 'SAFTCCITT_uLaw_44kHzMono',
           'Speech_StreamPos_Asap', 'SRTEmulated',
           'SpSharedRecognizer', 'SpeechCategoryVoices',
           'DISPID_SPPFirstElement', 'SpeechRecoProfileProperties',
           'SpeechRunState', 'SPSMF_SRGS_SAPIPROPERTIES',
           'SPSEMANTICFORMAT', 'DISPID_SpeechVoice', 'SPPARTOFSPEECH',
           'DISPID_SLPs_NewEnum', 'ISpeechPhraseElements',
           'SPINTERFERENCE_TOOFAST', 'SAFT32kHz8BitStereo',
           'DISPID_SPAs_NewEnum', 'SPLO_STATIC',
           'eLEXTYPE_MORPHOLOGY', 'DISPID_SpeechLexicon',
           'DISPID_SRGCmdSetRuleState', 'ISpRecoContext2',
           'SP_VISEME_20', 'SRTAutopause', 'DISPID_SPEsCount',
           'SRESoundStart', 'SPINTERFERENCE', 'SAFT16kHz8BitMono',
           'DISPID_SRCResume', 'SPDKL_CurrentConfig', 'SPAR_Unknown',
           'SPPS_RESERVED3', 'SP_VISEME_18', 'DISPID_SRDisplayUI',
           'SAFT44kHz8BitMono', 'DISPID_SGRSTPropertyValue',
           'SREBookmark', 'SpeechEngineProperties',
           'eLEXTYPE_VENDORLEXICON', 'SPBO_PAUSE',
           'ISpeechGrammarRules', 'SPGS_ENABLED',
           'SGDSActiveWithAutoPause', 'DISPID_SRRTimes',
           'SDKLCurrentConfig', 'SP_VISEME_0', 'SpeechTokenKeyUI',
           'DISPID_SPPsCount', 'ISpeechPhoneConverter',
           'SPCATEGORYTYPE', 'SVSFNLPSpeakPunc', 'SVEEndInputStream',
           'SAFT8kHz8BitMono', 'ISpeechCustomStream',
           'DISPID_SpeechLexiconProns', 'DISPID_SRGetRecognizers',
           'DISPID_SpeechGrammarRuleStateTransition', 'SITooLoud',
           'SVP_7', 'SGLexicalNoSpecialChars',
           'DISPID_SPPBRestorePhraseFromMemory', 'SRAInterpreter',
           'eLEXTYPE_PRIVATE9', 'WAVEFORMATEX', 'SVSFIsNotXML',
           'SINoSignal', 'SVP_13', 'SP_VISEME_6', 'SPPHRASEELEMENT',
           'SPRECOCONTEXTSTATUS', 'DISPID_SpeechLexiconPronunciation',
           'SRERequestUI', 'DISPID_SWFEBitsPerSample', 'SPPS_Verb',
           'SRTExtendableParse', 'SPWORDLIST', 'SPSHT_NotOverriden',
           'DISPID_SRCBookmark', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
           'SAFT16kHz16BitStereo', 'SPPS_RESERVED2',
           'SpeechPropertyResponseSpeed', 'SRTReSent', 'SPEI_MAX_SR',
           'SPWORDPRONOUNCEABLE', 'DISPID_SVEStreamStart',
           'DISPID_SRAudioInput', 'SpeechDiscardType',
           'DISPID_SPIAudioSizeBytes', 'SPGRAMMARSTATE',
           'DISPID_SGRSTText', 'DISPID_SDKOpenKey',
           'IInternetSecurityManager', 'SPEI_END_SR_STREAM', 'SLTApp',
           'SDA_No_Trailing_Space', 'SPVISEMES', 'SPSHT_OTHER',
           'ISpLexicon', 'SSSPTRelativeToEnd',
           'DISPID_SRSCurrentStreamPosition', 'SPPS_Interjection',
           'SPSEMANTICERRORINFO', 'SpeechRecoContextState',
           'DISPID_SVPause', 'DISPID_SABufferInfo',
           'SpeechGrammarTagDictation', 'SP_VISEME_1',
           'SGPronounciation', 'DISPIDSPTSI_ActiveLength',
           'SAFTCCITT_ALaw_44kHzMono', 'ISpeechPhraseProperty',
           'SPCONTEXTSTATE', 'SAFT32kHz16BitMono',
           'SREPropertyStringChange', 'SPWORD',
           'SpObjectTokenCategory', 'SPSERIALIZEDRESULT',
           'DISPID_SPRuleName', 'SPRST_NUM_STATES',
           'DISPID_SDKCreateKey', 'SSSPTRelativeToStart',
           'ISpeechAudioFormat', 'SPCT_SUB_COMMAND', 'SRATopLevel',
           'DISPID_SRRSaveToMemory', 'SPEI_RECO_STATE_CHANGE',
           'SPRECOGNIZERSTATUS', 'eLEXTYPE_USER',
           'SAFTCCITT_uLaw_44kHzStereo', 'ISpStream',
           'ISpeechLexiconWord', 'DISPID_SpeechMemoryStream',
           'SAFTCCITT_ALaw_44kHzStereo', 'SAFTCCITT_ALaw_11kHzStereo',
           'SP_VISEME_3', 'SAFTGSM610_11kHzMono', 'SGSDisabled',
           'SAFT44kHz8BitStereo', 'SAFTText', 'ISpeechGrammarRule',
           'DISPID_SWFEBlockAlign', 'DISPID_SVSLastBookmark',
           'DISPID_SRProfile', 'eLEXTYPE_PRIVATE17',
           'ISpeechObjectTokens', 'SVP_5', 'eLEXTYPE_RESERVED4',
           'ISpeechRecoResultTimes', 'eLEXTYPE_RESERVED9',
           'SVSFVoiceMask', 'ISpeechPhraseElement',
           'DISPID_SRCEPropertyNumberChange',
           'DISPID_SRCERecognitionForOtherContext',
           'DISPID_SRGCmdLoadFromMemory', 'SPRST_INACTIVE_WITH_PURGE',
           'SPEI_SR_PRIVATE', 'DISPID_SLAddPronunciation',
           'DISPID_SpeechFileStream', 'DISPID_SVSLastBookmarkId',
           'ISpPhrase', 'SpeechStreamFileMode',
           'DISPID_SVGetAudioOutputs', 'DISPID_SRRGetXMLResult',
           'STSF_LocalAppData', 'SREPhraseStart',
           'DISPID_SRCEAdaptation', 'DISPID_SRIsUISupported',
           'SpeechRegistryLocalMachineRoot', 'SFTInput',
           'DISPID_SRCESoundStart', 'SPEI_ACTIVE_CATEGORY_CHANGED',
           'ISpeechPhraseAlternates', 'SPCT_SUB_DICTATION',
           'DISPID_SBSSeek', 'SASPause', 'SpeechCategoryAppLexicons',
           'SPPHRASEPROPERTY', 'DISPID_SLPLangId',
           'DISPID_SRCEventInterests', 'ISpPhraseAlt',
           'SRERecoOtherContext', 'SpeechRecognitionType',
           'DISPID_SVEPhoneme', 'SpeechSpecialTransitionType',
           'DISPID_SOTIsUISupported', 'SAFT11kHz16BitStereo',
           'SAFT24kHz8BitStereo', 'SPSHORTCUTPAIR',
           'SPINTERFERENCE_TOOLOUD', 'SSTTTextBuffer',
           'SREAudioLevel', 'DISPID_SPRs_NewEnum',
           'ISpObjectTokenCategory', 'DISPIDSPTSI_SelectionLength',
           'SPEI_TTS_PRIVATE', 'SPVPRI_NORMAL',
           'ISpeechLexiconPronunciations', 'SpeechCategoryAudioOut',
           'SDTDisplayText', 'SPRS_INACTIVE', 'SpeechPartOfSpeech',
           'DISPID_SRRSpeakAudio', 'SpInProcRecoContext', 'SVP_15',
           'SVSFIsFilename', 'SP_VISEME_15', 'SpVoice',
           'DISPID_SCSBaseStream', 'SSFMOpenReadWrite',
           'ISpeechObjectTokenCategory', 'ISpGrammarBuilder',
           'SpeechTokenKeyFiles', 'SDKLLocalMachine',
           'SPEI_HYPOTHESIS', 'DISPID_SWFESamplesPerSec',
           'DISPID_SPRuleId', 'SpSharedRecoContext',
           'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVStatus',
           'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPIEngineId',
           'SpCustomStream', 'SPPS_Modifier', 'SPSHT_Unknown',
           'DISPID_SRGRules', 'STSF_AppData', 'SPPS_RESERVED4',
           'DISPID_SRIsShared', 'SVP_3', 'SREStreamStart',
           'ISpeechRecoResult2', 'DISPID_SRCEAudioLevel',
           'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCSetAdaptationData',
           'eLEXTYPE_PRIVATE3', 'SRARoot', 'SPXRO_Alternates_SML',
           'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPISaveToMemory',
           'DISPID_SRRecognizer', 'SREInterference', 'SRSActive',
           'DISPID_SVResume', 'DISPID_SRRAlternates', 'SGSExclusive',
           'SRESoundEnd', 'SPPS_RESERVED1',
           'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLWs_NewEnum',
           'DISPID_SRCRequestedUIType', 'SPEI_WORD_BOUNDARY',
           'SpeechMicTraining', 'SVP_14',
           'SWPUnknownWordUnpronounceable', 'DISPID_SVEventInterests',
           'SpeechRuleAttributes', 'SAFT11kHz16BitMono',
           'DISPID_SRSNumberOfActiveRules', 'SAFT12kHz8BitStereo',
           'DISPID_SOTCreateInstance', 'SpeechGrammarState',
           'SAFTADPCM_11kHzStereo', 'SPTEXTSELECTIONINFO',
           'SPEI_MIN_TTS', 'DISPID_SVAudioOutput',
           'SVESentenceBoundary', 'SPXRO_SML',
           'DISPID_SpeechRecognizer', 'DISPID_SPCPhoneToId',
           'DISPID_SPRuleNumberOfElements', 'SDKLDefaultLocation',
           'DISPID_SLWLangId', 'SPRECOSTATE', 'DISPID_SDKDeleteKey',
           'DISPID_SREmulateRecognition',
           'DISPID_SRSSupportedLanguages',
           'DISPID_SGRSAddSpecialTransition', 'SITooSlow',
           'DISPID_SMSAMMHandle', 'ISpeechPhraseReplacement',
           'DISPID_SpeechCustomStream', 'ISpeechPhraseInfoBuilder',
           'DISPID_SGRClear', 'SPWF_INPUT', 'ISpShortcut',
           'eLEXTYPE_RESERVED8', 'SVPOver', 'SP_VISEME_8',
           'DISPID_SAFSetWaveFormatEx', 'SPEI_SOUND_START',
           'SPWORDPRONUNCIATIONLIST', 'SPPS_SuppressWord',
           'SPFM_OPEN_READONLY', 'SPRS_ACTIVE_USER_DELIMITED',
           'SAFT24kHz16BitMono', 'STCRemoteServer',
           'SREFalseRecognition', 'DISPID_SLPsItem',
           'DISPID_SRStatus', 'SGDSActive', 'SAFTADPCM_8kHzStereo',
           'SpeechPropertyComplexResponseSpeed', 'SPSFunction',
           'SAFT12kHz16BitMono', '__MIDL_IWinTypes_0009',
           'DISPID_SVEAudioLevel', 'DISPID_SRCCmdMaxAlternates',
           'IEnumSpObjectTokens', 'DISPID_SVSPhonemeId', 'SLOStatic',
           'DISPID_SRRPhraseInfo', 'SPLEXICONTYPE', 'DISPID_SVRate',
           'SPEI_RESERVED6', 'DISPID_SRGCommit',
           'SAFTADPCM_44kHzMono', 'DISPID_SOTCategory',
           'DISPID_SRGRecoContext', 'SPEVENTSOURCEINFO',
           'SpeechLoadOption', 'DISPID_SPILanguageId',
           'SSFMCreateForWrite', 'DISPID_SRCERequestUI',
           'DISPID_SWFEExtraData', 'SpNotifyTranslator',
           'DISPID_SABIMinNotification',
           'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_21',
           'DISPID_SRRAudio', 'ISpNotifySink', 'SP_VISEME_2', 'SVP_0',
           'DISPID_SRCEFalseRecognition', 'SpeechWordType',
           'DISPID_SOTGetAttribute', 'DISPID_SVSRunningState',
           'DISPID_SASNonBlockingIO', 'ISpeechRecoResultDispatch',
           'SPPS_Unknown', 'DISPID_SVEVoiceChange',
           'SpeechFormatType', 'DISPID_SPPs_NewEnum',
           'SAFT24kHz16BitStereo', 'SP_VISEME_17',
           'SAFT48kHz8BitMono', 'DISPID_SPIEnginePrivateData',
           'SPCS_DISABLED', 'eLEXTYPE_RESERVED10', 'DISPIDSPRG',
           'SpeechInterference', 'DISPID_SPIProperties',
           'SDTPronunciation', 'Speech_Max_Word_Length',
           'DISPID_SVEWord', 'SPPROPERTYINFO',
           'DISPID_SPRuleEngineConfidence', 'SpNullPhoneConverter',
           'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_21',
           'SVP_2', 'SP_VISEME_12', 'DISPID_SOTRemove',
           'DISPID_SpeechVoiceStatus', 'eLEXTYPE_USER_SHORTCUT',
           'DISPID_SRCPause', 'eLEXTYPE_PRIVATE16',
           '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechVoice',
           'SpeechVisemeFeature', 'SAFTADPCM_11kHzMono',
           '_ISpeechRecoContextEvents', 'DISPID_SRState',
           'ISpeechLexiconWords', 'SSFMOpenForRead',
           'DISPID_SpeechPhraseAlternate', 'SPWAVEFORMATTYPE',
           'SPDKL_CurrentUser', 'DISPID_SABIEventBias',
           'DISPID_SVGetProfiles', 'DISPID_SVSInputWordLength',
           'SPGS_DISABLED', 'SPSVerb', 'SpeechAudioVolume',
           'DISPID_SASState', 'SLODynamic', 'SPAS_STOP',
           'SPEI_RECOGNITION', 'DISPID_SLWType', 'ISpeechRecoContext',
           'SpeechGrammarTagWildcard', 'DISPID_SRGDictationUnload',
           'SPPS_Noun', 'DISPID_SPPsItem', 'ISpStreamFormat',
           'SpShortcut', 'SPAS_RUN', 'eLEXTYPE_PRIVATE14',
           'SAFT12kHz16BitStereo', 'SpMemoryStream',
           'DISPID_SVDisplayUI', 'ISpeechRecognizerStatus',
           'SPEI_RESERVED1', 'SAFT22kHz8BitStereo', 'ISpRecoGrammar',
           'DISPID_SGRSTs_NewEnum',
           'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
           'ISpObjectToken', 'SVP_6', 'DISPID_SVIsUISupported',
           'SPEI_FALSE_RECOGNITION', 'DISPID_SPIAudioSizeTime',
           'SPVPRI_OVER', 'SPCT_DICTATION',
           'DISPID_SLAddPronunciationByPhoneIds',
           'SpeechPropertyHighConfidenceThreshold',
           'ISpPhoneticAlphabetConverter', 'IEnumString',
           'SAFTNonStandardFormat', 'SPFILEMODE',
           'ISpObjectWithToken', 'SPEI_SR_AUDIO_LEVEL',
           'DISPID_SRCEHypothesis', 'DISPID_SOTDataKey',
           'SAFT44kHz16BitStereo', 'DISPID_SPIRetainedSizeBytes',
           'DISPID_SGRSTType', 'DISPID_SRRTTickCount',
           'DISPID_SDKSetLongValue', 'SpeechRegistryUserRoot',
           'DISPID_SRSAudioStatus', 'SpeechCategoryAudioIn',
           'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
           'SPSERIALIZEDPHRASE', 'SpeechRecognizerState',
           'SPSUnknown', 'DISPID_SGRSTRule',
           'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
           'DISPID_SDKGetStringValue', 'SPEI_RECO_OTHER_CONTEXT',
           'DISPID_SPEAudioTimeOffset', 'DISPID_SRRTLength',
           'SpeechAudioFormatGUIDText', 'SAFTCCITT_ALaw_11kHzMono',
           'SPINTERFERENCE_NONE', 'SAFT8kHz8BitStereo',
           'ISpRecoGrammar2', 'SAFT22kHz16BitMono',
           'DISPID_SPRuleChildren', 'DISPID_SVEEnginePrivate',
           'SPVPRIORITY', 'DISPID_SPRuleConfidence',
           'DISPID_SGRsCount', 'SPRST_ACTIVE', 'SVP_8',
           'DISPID_SWFEAvgBytesPerSec', 'SPINTERFERENCE_NOISE',
           'SPEI_SOUND_END', 'Speech_Max_Pron_Length',
           'SpPhoneticAlphabetConverter', 'SRTStandard',
           'DISPID_SRCERecognition', 'SDKLCurrentUser',
           'SPSHORTCUTTYPE', 'DISPID_SOTCEnumerateTokens',
           'DISPID_SVSLastStreamNumberQueued', 'SDTAll',
           'SPSInterjection', 'SpeechStreamSeekPositionType',
           'DISPID_SpeechRecognizerStatus',
           'DISPID_SPIAudioStreamPosition', 'SAFT24kHz8BitMono',
           'DISPID_SOTId', 'SpeechAudioProperties',
           '_RemotableHandle', 'SP_VISEME_4', 'UINT_PTR',
           'SP_VISEME_16', 'ISpStreamFormatConverter']
from comtypes import _check_version; _check_version('1.1.9', 1610774006.195501)
